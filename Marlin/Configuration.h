 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//TODO: Work out microstepping
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.10, 81.29, 400, 100.04 } //Y comes perfect
// Mircrostepping to 64
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 320.40, 325.16, 1600, 401.6 } //Y comes perfect
...
#define DEFAULT_MAX_ACCELERATION      { 1500, 1200, 150, 3000 }
// #define DEFAULT_MAX_ACCELERATION { 180, 180, 80, 180 } //v1eng values
...
#define DEFAULT_ACCELERATION          2000    //v1eng 700    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 // v1eng lowrideruse 0.04! (mm) Distance from real junction edge
 ...
 */
#define S_CURVE_ACCELERATION //enabled in v1eng
