...
#define STRING_CONFIG_H_AUTHOR "(Fabio Viappiani, Santiago Project)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Santiago 3D"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 10000 } // { 3000, 3000, 100, 10000 }
...
#define DEFAULT_TRAVEL_ACCELERATION   1500 //800 // 3000    // X, Y, Z acceleration for travel (non printing) moves
...
#define NOZZLE_TO_PROBE_OFFSET { 24.40, 31.80, -1.50 } //added 30 to y for spacers
...
RETRACT
  ...
  #define GRID_MAX_POINTS_X 6     // Don't use UBL more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_LED_INDEX  9               // Index of the LED to use
