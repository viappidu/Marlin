...
//
  ...
  #define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE 2        // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve.
      ...
      #define CHAMBER_FAN_BASE  85   // Minimum chamber fan PWM (0-255)
 ...
 */
//TODO Add a controller fan (anytime)
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN NEOPIXEL_PIN //P1_24 //4                  // Override the default pin if needed
  //#define INVERT_CASE_LIGHT             // Set true if Case Light is ON when pin is LOW
...
// #define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 10 }, { 240,  10 }, { 240, 220 }, { 40, 220 } }
...
//#define DIGIPOT_MCP4451
  ...
  //TODO: check why these were enabled in previous build
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define SD_FIRMWARE_UPDATE
    ...
    #define SD_FIRMWARE_UPDATE_EEPROM_ADDR    0x08008000 //0x1FF
...
#define LASER_FEATURE
  ...
  //#define SPINDLE_LASER_FREQUENCY       20 //ORIGINAL 2500   // (Hz) Spindle/laser frequency (only on supported HALs: AVR and LPC)
